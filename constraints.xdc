...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {ips2_clk}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {ips2_data}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {otx}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {SCL_SEG}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {SDA_SEG}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {irx}];  # "JA8"
#set_property PACKAGE_PIN AB9  [get_ports {otx}];  # "JA9"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {SCL_LCD}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {SDA_LCD}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {irx}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {SDA_SEG}];  # "JB4"
...
set_property PACKAGE_PIN T18 [get_ports {ireset}];  # "BTNU"
